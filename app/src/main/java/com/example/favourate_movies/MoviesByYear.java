...
public class MoviesByYear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent()!=null && getIntent().getExtras()!=null) {
            list = getIntent().getParcelableArrayListExtra(MainActivity.SORT_YEAR_CODE);

            final int j = list.size();


            //Log.i("intentlist",list.toString());
            ...
            firstMovieIv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (i == 0) {
                        Toast.makeText(MoviesByYear.this, "This is First Movie", Toast.LENGTH_SHORT).show();
                    } else {
                        i = 0;
                        movienametext.setText(list.get(i).movieName);
                        descriptionText.setText(list.get(i).movieDescription);
